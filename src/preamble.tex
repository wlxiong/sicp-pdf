...
\lstset{%
  % Scheme syntax highlighter
    ...
    % Paint error red:
    emph={[2]error},emphstyle=[2]\color{SchemeDark},%
    ...
    emphstyle=[3]\color{SchemeDark},%
    %
    basicstyle=\color{SchemeDark}\ttfamily,
    keywordstyle=\color{SchemeDark}\bfseries,
    identifierstyle=\color{SchemeDark},
    stringstyle=\color{SchemeDark},
    commentstyle=\color{SchemeDark}\itshape,
}
...
\titleformat{\chapter}[display]
  ...
  {\filright \color{SchemeDark}\sffamily\mdseries
...
{\color{SchemeDark}\thesection}{0.8em}{}

\titleformat{\subsection}
{\color{SchemeDark}\normalfont\large\sffamily\bfseries}
{\color{SchemeDark}\thesubsection}{0.8em}{}

\titleformat{\subsubsection}
{\color{black}\normalfont\normalsize\sffamily\bfseries}
{\color{SchemeDark}\thesubsubsection}{0.8em}{}
